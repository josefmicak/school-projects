#include "ArraySearchingAlgorithms.h"
	...
	namespace Algorithms
	{
		namespace ArraySearchingAlgorithms
		{
			...
			bool LinearSearchRecursive3(const int a[], const int l, const int r, const int x)
			{
				...
				return LinearSearchRecursive3(a, l, m - 1, x) || LinearSearchRecursive3(a, m + 1, r, x);
			}
			...
			bool LinearSearchRecursive4(const int a[], const int l, const int r, const int x)
			{
				...
				if (LinearSearchRecursive4(a, l, m - 1, x))
				{
					return true;
				}
				return LinearSearchRecursive4(a, m + 1, r, x);
			}
