...
namespace RestauraceORM.Databaze.mssql
{
   ...
   //     public static string SQL_SELECT_ID = "SELECT Id_objednavky, Id_zakaznika, Id_zamestnance, Id_rozvazky, Datum_vytvoreni, Cena, Vyplacena FROM \"Objednavka\" WHERE Id_objednavky = @id";
        ...
        protected override DatabaseProxy slevaObjednavky(Objednavka objednavka, DatabaseProxy pDb = null)
        {
            Database db;
            if (pDb == null)
            {
            ...
            SqlCommand command = db.CreateCommand("sleva_objednavky");
