...
CREATE TABLE zakaznikstatistika (
    datum_statistiky    DATE NOT NULL,
    pocet_neaktivnich   INTEGER NOT NULL,
    pocet_zrusenych     INTEGER NOT NULL
);
